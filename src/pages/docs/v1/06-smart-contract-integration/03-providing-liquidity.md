...
The easiest way to safely add liquidity to a pool is to use the <Link to='/docs/v1/smart-contracts/router02'>router</Link>, which provides simple methods to safely add liquidity to a pool. If the liquidity is to be added to an ERC-20/ERC-20 pair, use <Link to='/docs/v1/smart-contracts/router02/#addliquidity'>addLiquidity</Link>. If WETH is involved, use <Link to='/docs/v1/smart-contracts/router02/#addliquidityeth'>addLiquidityETH</Link>.
