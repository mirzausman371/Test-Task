...
All Kwikswap pool tokens support meta-transaction approvals via the <Link to='/docs/v1/smart-contracts/pair-erc-20#permit'>permit</Link> function. This obviates the need for a blocking approve transaction before programmatic interactions with pool tokens can occur.
...
- `name` is always `Kwikswap`, see <Link to='/docs/v1/smart-contracts/pair-erc-20#name'>name</Link>.
