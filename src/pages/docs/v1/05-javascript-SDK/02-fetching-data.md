...
Now that we've explored how to define a token, let's talk about pairs. To read more about what Kwikswap pairs are, see <Link to='/docs/v1/smart-contracts/pair'>Pair</Link>.
