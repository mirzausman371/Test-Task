...
The Route entity represents one or more ordered Brainaut pairs with a fully specified path from input token to output token.

# Example

```typescript
import { ChainId, Token, TokenAmount, Pair, Route } from '@simocos/sdk'
